  ...
  const features = [
    {
      ...
      description: "Analyze thousands of transactions in seconds with our advanced algorithms"
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: "AI-powered anomaly detection finds discrepancies you might miss"
    },
    {
      icon: TrendingUp,
      title: "Detailed Reports",
      description: "Export comprehensive audit reports for accounting and compliance"
    }
  ];
        ...
        <div className="container mx-auto text-center space-y-8 max-w-4xl">
          <div className="space-y-4">
            ...
            <h2 className="text-5xl font-bold text-foreground leading-tight">
              Sync Your Financial 
              <span className="bg-gradient-primary bg-clip-text text-transparent"> Statements</span>
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Upload your bank and shop statements, and let our AI-powered system find discrepancies, 
              missing transactions, and anomalies in seconds.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-card/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center space-y-4 mb-16">
            <h3 className="text-3xl font-bold text-foreground">Why Choose StatementSync?</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card key={index} className="border-border shadow-md hover:shadow-lg transition-fast">
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {useCases.map((useCase, index) => (
              <Card key={index} className="border-border shadow-md hover:shadow-lg transition-fast text-center">
        ...
        <div className="container mx-auto text-center max-w-3xl">
          <div className="space-y-6">
            ...
            <p className="text-lg text-primary-foreground/90">
              Join thousands of businesses already using StatementSync to save time and ensure accuracy.
            </p>
            <Button 
              variant="secondary" 
              size="lg"
        ...
        <div className="container mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-foreground">StatementSync</span>
            </div>
