...
const Dashboard = () => {
  ...
  const handleStartMatching = async () => {
    ...
    try {
      ...
      const matchAccuracy =
        (data.stats as any)?.confidencePct ??
        Math.round((matched / Math.max(1, total)) * 100);
      setResults({
        ...
        anomalies: (data.anomalies || []).map((a: any) => ({
          ...
          status:
            a.type === "missing_in_bank"
              ? "Missing Transaction"
              : a.type === "missing_in_shop"
              ? "Missing Transaction"
              : "Amount Mismatch",
        ...
        <div className="space-y-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6">
            <Card className="border-border shadow-md hover:shadow-lg transition-fast">
              <CardHeader>
                ...
                <CardDescription>
                  Upload your bank statement (Excel)
                </CardDescription>
              </CardHeader>
              <CardContent>
                <FileUpload
          ...
          <Card className="border-border shadow-md">
            <CardHeader>
              ...
              <CardDescription>
                Select a specific month or let us auto-detect from your
                statements
              </CardDescription>
            </CardHeader>
              ...
              <div className="space-y-4">
                ...
                {!selectedMonth && (
                  <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                    ...
                    <span>
                      Auto-detect mode enabled - we'll analyze the full
                      statement period
                    </span>
                  </div>
                )}
            ...
            <div className="space-y-6">
                ...
                <Card className="border-border">
                  ...
                  <CardContent className="text-sm space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span>
                        {results.serverStats?.bankOpeningBalance ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Closing Balance</span>
                      <span>
                        {results.serverStats?.bankClosingBalance ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Debit</span>
                      <span>
                        {results.serverStats?.bankTotals?.debit ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Credit</span>
                      <span>
                        {results.serverStats?.bankTotals?.credit ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Transactions</span>
                      <span>{results.serverStats?.bankTxCount ?? "-"}</span>
                    </div>
                  </CardContent>
                </Card>
                <Card className="border-border">
                  ...
                  <CardContent className="text-sm space-y-1">
                    <div className="flex justify-between">
                      <span>Opening Balance</span>
                      <span>
                        {results.serverStats?.shopOpeningBalance ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Closing Balance</span>
                      <span>
                        {results.serverStats?.shopClosingBalance ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Debit</span>
                      <span>
                        {results.serverStats?.shopTotals?.debit ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Total Credit</span>
                      <span>
                        {results.serverStats?.shopTotals?.credit ?? "-"}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>Transactions</span>
                      <span>{results.serverStats?.shopTxCount ?? "-"}</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="border-border">
                <CardHeader>
                  ...
                  <CardDescription>
                    Numbers must match across both sources
                  </CardDescription>
                </CardHeader>
                <CardContent className="text-sm space-y-2">
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        results.serverStats?.txCountEqual
                          ? "text-success"
                          : "text-destructive"
                      }
                    >
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        results.serverStats?.totalsEqual
                          ? "text-success"
                          : "text-destructive"
                      }
                    >
